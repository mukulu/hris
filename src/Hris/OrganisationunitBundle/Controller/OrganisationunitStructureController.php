...
class OrganisationunitStructureController extends Controller
{
     ...
     *
     * @Secure(roles="ROLE_ORGANISATIONUNITSTRUCTURE_LIST,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_ORGANISATIONUNITSTRUCTURE_CREATE,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_ORGANISATIONUNITSTRUCTURE_SHOW,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_ORGANISATIONUNITSTRUCTURE_UPDATE,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_ORGANISATIONUNITSTRUCTURE_DELETE,ROLE_USER")
