...
class RelationalFilterController extends Controller
{
     ...
     *
     * @Secure(roles="ROLE_RELATIONALFILTER_LIST,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_RELATIONALFILTER_CREATE,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_RELATIONALFILTER_SHOW,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_RELATIONALFILTER_UPDATE,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_RELATIONALFILTER_DELETE,ROLE_USER")
