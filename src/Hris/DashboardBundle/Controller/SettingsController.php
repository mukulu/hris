...
class SettingsController extends Controller
{
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_SETTINGS_SHOW,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_SETTINGS_CREATE,ROLE_USER")
     ...
     *
     * @Secure(roles="ROLE_SUPER_USER,ROLE_SETTINGS_DELETE,ROLE_USER")
