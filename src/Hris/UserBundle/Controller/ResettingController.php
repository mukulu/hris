...
class ResettingController extends ContainerAware
{
    ...
    {
        return $this->container->get('templating')->renderResponse('HrisUserBundle:Resetting:request.html.'.$this->getEngine());
    }
    ...
    public function sendEmailAction()
    {
        ...
        if (null === $user) {
            return $this->container->get('templating')->renderResponse('HrisUserBundle:Resetting:request.html.'.$this->getEngine(), array('invalid_username' => $username));
        }

        if ($user->isPasswordRequestNonExpired($this->container->getParameter('fos_user.resetting.token_ttl'))) {
            return $this->container->get('templating')->renderResponse('HrisUserBundle:Resetting:passwordAlreadyRequested.html.'.$this->getEngine());
        }
